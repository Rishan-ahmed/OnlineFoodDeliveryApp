...
export const UPDATE_MANU_ITEM_AVAILABILITY_REQUEST = 'UPDATE_MANU_ITEM_AVAILABILITY_REQUEST'; 
export const UPDATE_MANU_ITEM_AVAILABILITY_SUCCESS = 'UPDATE_MANU_ITEM_AVAILABILITY_SUCCESS'; 
export const UPDATE_MANU_ITEM_AVAILABILITY_FAILURE = 'UPDATE_MANU_ITEM_AVAILABILITY_FAILURE'; 